...
const shortcuts = [
  ...
  { section: 'Features', items: [
    ...
    ['Ctrl+Shift+G', 'Session trail graph'],
    ['Ctrl+Shift+P', 'Page in PiP window'],
    ['Ctrl+Shift+S', 'Save page screenshot'],
    ['Ctrl+Shift+C', 'Copy page screenshot'],
    ['Ctrl+Shift+J', 'Duplicate tab'],
    ['Ctrl+Shift+V', 'Open URL from clipboard'],
    ['Ctrl+Shift+R', 'Save to reading list'],
    ['Ctrl+Shift+Y', 'Copy page URL'],
    ['Ctrl+Shift+U', 'Copy page title'],
    ['Ctrl+Shift+K', 'Copy all tab URLs'],
