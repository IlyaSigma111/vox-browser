...
export const THEMES: Record<ThemePreset, ThemeColors> = {
  ...
  'gx': {
    bg: '#0b0b12', bgDim: '#07070d', bgLight: '#1a1a28',
    fg: '#f3f0ff', fgDim: '#8f8fae', border: '#27273c',
    accent: '#ff2d7c', green: '#00ff9d', red: '#ff3b5c',
    orange: '#ff9e2c', cyan: '#00e0ff', purple: '#b95aff',
  },
  'gx-neon': {
    bg: '#06100a', bgDim: '#040a07', bgLight: '#0d2014',
    fg: '#eafff2', fgDim: '#5c8a70', border: '#14301f',
    accent: '#39ff88', green: '#39ff88', red: '#ff4060',
    orange: '#ffcc3d', cyan: '#19e3ff', purple: '#9d5cff',
  },
  'gx-magma': {
    bg: '#120606', bgDim: '#0c0404', bgLight: '#2b1010',
    fg: '#ffecec', fgDim: '#a07070', border: '#3a1818',
    accent: '#ff4d2e', green: '#7dff3a', red: '#ff2a2a',
    orange: '#ff9e2c', cyan: '#ffd166', purple: '#ff6ea9',
  },
  'gx-royal': {
    bg: '#0c0817', bgDim: '#080510', bgLight: '#1d1233',
    fg: '#f2ecff', fgDim: '#8578a8', border: '#2b1e47',
    accent: '#9d5cff', green: '#3dff8f', red: '#ff4d6d',
    orange: '#ffb84d', cyan: '#5cd7ff', purple: '#d15cff',
  },
  'gx-teal': {
    bg: '#06141a', bgDim: '#040e13', bgLight: '#0e2630',
    fg: '#e6fbff', fgDim: '#5d8f9c', border: '#17303c',
    accent: '#19e3ff', green: '#2cff9d', red: '#ff5c7a',
    orange: '#ffb84d', cyan: '#19e3ff', purple: '#8f7aff',
  },
  'gx-gold': {
    bg: '#120c02', bgDim: '#0c0801', bgLight: '#24190a',
    fg: '#fff6e0', fgDim: '#a88f55', border: '#33260e',
    accent: '#ffb02e', green: '#7dff3a', red: '#ff5c4d',
    orange: '#ff7b2e', cyan: '#ffd166', purple: '#ff9de2',
  },
  'gx-ice': {
    bg: '#0a101c', bgDim: '#070c15', bgLight: '#16233a',
    fg: '#eef4ff', fgDim: '#6b83a8', border: '#1f2e4a',
    accent: '#5ca8ff', green: '#5dffb0', red: '#ff6b7d',
    orange: '#ffb86c', cyan: '#9adcff', purple: '#a78bff',
  },
  'custom': {
    bg: '#1a1b26', bgDim: '#16161e', bgLight: '#24283b',
    fg: '#c0caf5', fgDim: '#565f89', border: '#292e42',
...
const defaultSettings: Settings = {
  ...
  gamingPrevTheme: undefined,
  debloatPrevTabPos: undefined,
  language: 'en',
  ...
  dynamicisland: false, cursorglow: false, docklift: false, uiMode: 'full',
